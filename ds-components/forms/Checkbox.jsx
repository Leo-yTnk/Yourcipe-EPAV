  ...
  return (
    <label style={{display:'inline-flex', alignItems:'center', gap:10, fontFamily:'var(--font-sans)', cursor: disabled ? 'not-allowed' : 'pointer', opacity: disabled ? 0.6 : 1}}>
      ...
      <span style={{
        ...
        border: `1.5px solid ${checked ? 'var(--brand-700)' : 'var(--border-default)'}`,
        background: checked ? 'var(--brand-700)' : 'var(--surface-primary)', color:'var(--neutral-0)', fontSize:13, transition:'all 0.12s ease'
      }}>{checked && '✓'}</span>
