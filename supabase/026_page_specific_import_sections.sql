-- Yourcipe V0.43 — align spreadsheet recipe sections with migration 023.
-- Apply after 025. Migration 023 split the legacy `secao` type into page-specific
-- types; the old importer still selected `secao`, causing the reference trigger
-- to reject recipe_categories inserts.
