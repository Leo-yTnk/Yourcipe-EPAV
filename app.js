import { h, html, render, Component } from './vendor/htm-preact-standalone.js?v=20260901-1';
...
} from './data.js?v=20260901-1';
import { generateCredential, normalizeCredential } from './credential.js?v=20260901-1';
import { supabase } from './supabase-client.js?v=20260901-1';
import { parseNonNegativePrice, validateName, validateOptionalHttpUrl } from './input-validation.js?v=20260901-1';
import { parseBRLPrice, priceEditPolicy, summarizeBulkResults, toggleSelected } from './bulk-actions.js?v=20260901-1';
import { signUpAttempt, signInWithCredential, fetchProfile, updateDisplayName, signOut, AUTH_GENERIC_ERROR, MAX_SIGNUP_ATTEMPTS } from './auth.js?v=20260901-1';
import { runSignupRetryLoop } from './signup-retry.js?v=20260901-1';
import { normalizeDisplayName } from './display-name.js?v=20260901-1';
import * as catalog from './catalog.js?v=20260901-1';
import { getTopmostModal, isTextareaElement, resolveEscapeAction, resolveEnterAction, isDoubleSubmit } from './modal-keyboard.js?v=20260901-1';
import { shouldShowWelcome, markWelcomeSeen } from './welcome.js?v=20260901-1';
import { createLoadGuard } from './load-guard.js?v=20260901-1';
import { shouldApplyAuthEvent } from './auth-events.js?v=20260901-1';
import { buildSwiftSyncReport } from './swift-sync-ui.js?v=20260901-1';
import { parseCatalogSectionLinkRow } from './import-contract.js?v=20260901-1';
...
const FRONTEND_VERSION = '20260901-1';
...
class App extends Component {
  ...
  state = (() => {
    ...
    return {
      ...
      importParsedRecipeSections: [],
      importParsedProductSections: [],
      importErrors: [],
      importWarnings: [],
  ...
  applySessionProfile = (session, profile) => {
    // On a reload, `session` is still null in the current state until this
    // update is committed. loadSalesData() intentionally refuses to fetch
    // without a session, so calling it immediately after setState used to
    // make the restored-session path return early and leave the chart/cards
    // rendering the empty local snapshot. Run the fetch from setState's
...
import { renderApp } from './template.js?v=20260901-1';
